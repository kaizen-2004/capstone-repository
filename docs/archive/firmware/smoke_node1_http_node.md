# Smoke Node 1 Firmware (`mq2_living`) - Arduino IDE
...
Open `firmware/legacy_http/smoke_node1/smoke_node1.ino` and edit these constants:
...
- `NODE_ID` (default `mq2_living`)
- `ROOM_NAME` (default `Living Room`)
