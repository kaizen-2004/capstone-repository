...
const char* FW_VERSION = "smoke_node1_wifi_diag_2026-03-05b";
...
void setup() {
  ...
  Serial.println("\n[BOOT] Smoke Node 1 started");
  Serial.printf("[BOOT] fw=%s node=%s room=%s pin=%d\n", FW_VERSION, NODE_ID, ROOM_NAME, MQ2_ADC_PIN);
