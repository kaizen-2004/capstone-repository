                ...
                if flame_detected:
                    ...
                    if entered_view and cooldown_ready:
                        ...
                        event_id = store.create_event(
                            ...
                            description="Possible fire detected by camera. Please check immediately.",
                            details=details,
                        )
    ...
    def _check_nodes(self) -> None:
        ...
        for row in offline_rows:
            ...
            event_id = store.create_event(
                ...
                description=f"{node_id} has not reported for {self.node_offline_seconds} seconds.",
    ...
    def _check_cameras(self) -> None:
        ...
        for row in store.list_cameras():
            ...
            event_id = store.create_event(
                ...
                description=f"{node_id} camera feed has been unavailable for {self.camera_offline_seconds} seconds.",
